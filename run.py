...
def main(argv, prog=''):
    ...
    print '----------------------------------\nTimings\n----------------------------------'
    # print 'Reading:    %g seconds'%((t2-t1)/cv2.getTickFrequency())
    # print 'Processing: %g seconds'%((t3-t2)/cv2.getTickFrequency())
    # print 'Writing:    %g seconds'%((t4-t3)/cv2.getTickFrequency())
